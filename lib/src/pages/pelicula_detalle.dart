...
class PeliculaDetalle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //recibiendo la información enviada desde arguments
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 20.0),
          //flexbile hace que tome todo el ancho restante de su padre
          Flexible(
            child: Column(
  ...
  Widget _crearCasting(int id){
    final actorProvider = ActoresProvider();
    return FutureBuilder(
      future: actorProvider.getCast(id.toString()),
